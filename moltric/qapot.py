...
import numpy as np
# from numba import jit  # Kazuumi commented this out for now
...
# from numba import njit  # Kazuumi commented this out for now
# @jit(nopython=True)     # Kazuumi commented this out for now
